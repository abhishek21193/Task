...
public class ProductListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while (cursor.moveToNext()){
            ...
            String regularPrice = cursor.getString(3);
            String salePrice = cursor.getString(4);
            byte[] image  = cursor.getBlob(5);
            //add to list
            mList.add(new Product(id, name, description, regularPrice, salePrice, image));
        }
    ...
    private void showDialogDelete(final int idRecord) {
        AlertDialog.Builder dialogDelete = new AlertDialog.Builder(ProductListActivity.this);
    ...
    private void showDialogUpdate(Activity activity, final int position){
        ...
        imageViewIcon = dialog.findViewById(R.id.imageProductPhotoss);
        final EditText edtName = dialog.findViewById(R.id.edtNamess);
        final EditText edtDescription = dialog.findViewById(R.id.edtDescriptionss);
        final EditText edtRegularPrice = dialog.findViewById(R.id.edtRegularPricess);
        final EditText edtSalePrice = dialog.findViewById(R.id.edtSalePricess);
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    if (edtName.getText().toString().isEmpty() || edtDescription.getText().toString().isEmpty() || edtRegularPrice.getText().toString().isEmpty() || edtSalePrice.getText().toString().isEmpty()) {
                        Toast.makeText(ProductListActivity.this, "Please insert all data to update", Toast.LENGTH_SHORT).show();
                    } else {
                        MainActivity.mSQLiteHelper.updateData(
                                edtName.getText().toString().trim(),
                                edtDescription.getText().toString().trim(),
                                edtRegularPrice.getText().toString().trim(),
                                edtSalePrice.getText().toString().trim(),
